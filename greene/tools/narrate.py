...
SPEED = 0.95
SCRIPT = "/home/user/battle-maps/greene/script.md"
OUT = "/home/user/battle-maps/greene/audio"
GAP_PARA, GAP_SECTION = 0.6, 0.8
# spoken-only spellings (Kokoro mispronounces these)
PRON = {"Eutaw": "Yoo-taw", "Guilford": "Gilford", "Nathanael": "Nathaniel", "Ramsour's": "Ramsowers", "Marchbanks": "Marshbanks", "Otho": "Oh-tho", "Banastre": "Banister"}
